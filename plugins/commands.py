    ...
    if data.startswith("all"):
        ...
        for file in files:
            ...
            await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ 𝑇𝓔ℒℒႸ 𝓒ℒ𝓞𝓤𝓓 ⚔️', url=f"https://t.me/TELLYCLOUD_bots") ] ] ),
            )
        return
    ...
    if not files_:
        ...
        try:
            msg = await client.send_cached_media(
                ...
                file_id=file_id,
                protect_content=True if pre == 'filep' else False,
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ 𝑇𝓔ℒℒႸ 𝓒ℒ𝓞𝓤𝓓 ⚔️', url="https://t.me/TELLYCLOUD_bots") ] ] ),
            )
            filetype = msg.media
